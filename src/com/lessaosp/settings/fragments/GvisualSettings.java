...
import com.android.internal.util.lessaosp.ThemesUtils;
...
public class GvisualSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.lessaosp_settings_gvisual);
    ...
    private int getOverlayPosition(String[] overlays) {
        ...
        for (int i = 0; i < overlays.length; i++) {
            ...
            if (LessaospUtils.isThemeEnabled(overlay)) {
                position = i;
            }
        }
        return position;
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.lessaosp_settings_gvisual);
}
